...
|------|-------------|-----------|------------|---------|
| `Master_Federal_Funds_Rate_Daily.csv` | Combined daily rate with target range | Daily | 1976-2026 | 18,338 |
| `DFF_federal_funds_effective_rate_daily.csv` | Federal Funds Effective Rate (DFF) from CalcFi/FRED | Daily | 1954-2026 | 26,384 |
| `EFFR_nyfed_with_target_range.csv` | EFFR from NY Fed with all columns | Daily | 2000-2026 | 6,592 |
| `EFFR_simplified.csv` | EFFR simplified (date, rate, target_low, target_high) | Daily | 2000-2026 | 6,592 |
| `FRED_DFF.csv` | Federal Funds Effective Rate from FRED | Daily | 1954-2026 | 26,384 |
...
| `FRED_DFEDTARL.csv` | Target Range Lower Limit (post-2008) | Daily | 2008-2026 | 6,493 |
| `FRED_DFEDTARU.csv` | Target Range Upper Limit (post-2008) | Daily | 2008-2026 | 6,493 |
| `DFEDTAR_target_range_from_nyfed.csv` | Target range extracted from NY Fed EFFR data | Daily | 2008-2026 | 4,466 |
...
| File | Description | Frequency | Date Range | Records |
|------|-------------|-----------|------------|---------|
| `FRED_CPIAUCSL.csv` | Consumer Price Index (CPI) | Monthly | 1947-2026 | 955 |
...
| `FRED_HSN1F.csv` | Housing Starts | Monthly | 1963-2026 | 764 |
...
- **Effective Rate (EFFR)**: 3.88% (as of 2026-09-24)
